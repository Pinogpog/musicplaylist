...
let songs = [
    ...
    },
    {
        id: 9,
        title: "Panaginip",
        artist: "Crazy As Pinoy",
        album: "Crazy as Pinoy",
        albumArtUrl: "https://images.genius.com/87f90331cf6c6179d75aa5489651873d.1000x1000x1.png",
        audioSrc: "audio/Panaginip.mp3",
        videoBgSrc: "videos/krm.mp4",
        lyrics: [
            { time: 50, text: "Bawat pikit ng aking mata" },
            { time: 20, text: "Tanging ikaw nakikita" },
            { time: 10, text: "Utak ko ay punong-puno" },
            { time: 12, text: "Ng imahinasyon kasama ka" },
            { time: 16, text: "Isang hiwa lang" },
            { time: 15, text: "Kung mapapasakin ka" },

            { time: 24, text: "Parang panaginip" },
            { time: 20, text: "Pag ika'y aking kapiling" },
            { time: 25, text: "Huwag kang tumingin sakin" },
            { time: 35, text: "Ako ay nahuhumaling" },
            { time: 39, text: "Ako ay nahuhumaling" },
            { time: 43, text: "Sayo... sayo... sayo..." },

            { time: 47, text: "Natutulala nalang sayo" },
            { time: 51, text: "Napapabagal mo aking mundo" },
            { time: 55, text: "Nasisilayan ko na" },
            { time: 59, text: "Ang kinabukasan ko sayo" },
            { time: 63, text: "Imahinasyon parin ba to?" },
            { time: 67, text: "Ikaw ay narito sa tabi ko" },

            { time: 71, text: "Parang panaginip" },
            { time: 75, text: "Pag ika'y aking kapiling" },
            { time: 79, text: "Huwag kang tumingin sakin" },
            { time: 83, text: "Ako ay nahuhumaling" },
            { time: 87, text: "Ako ay nahuhumaling" },
            { time: 91, text: "Sayo..." },

            { time: 95, text: "Paulit-ulit ka" },
            { time: 99, text: "Tumatakbo sa isip" },
            { time: 103, text: "Paulit-ulit ulit na lang" },
            { time: 107, text: "Pinapanalangin ka" },
            { time: 111, text: "Maaaring bang hawakan" },
            { time: 115, text: "Ang iyong mga kamay" },
            { time: 119, text: "Tayo na, tayo na" },
            { time: 123, text: "Lilipad ng sabay" },

            { time: 127, text: "Parang panaginip" },
            { time: 131, text: "Pag ikaw aking kapiling" },
            { time: 135, text: "Wag tumingin sakin" },
            { time: 139, text: "Ako ay nahuhumaling" },
            { time: 143, text: "Sayo..." }
        ]
    }
];
